...
public class DesUtils {
     ...
     * 偏移变量，固定占8位字节
     */
    private final static String IV_PARAMETER = "13345928";
    public final static String PASSWORD = "pass@word1";
    /**
     * 密钥算法
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(DesUtils.decrypt(PASSWORD,encryptKey));
